...
# 2 creating our star schema with python 
...
# 3 read denormalized data from csv, put it into a pandas dataframe, and send to the sqlite database
...
# 4 Inserting data into our Dimension and Fact Tables
